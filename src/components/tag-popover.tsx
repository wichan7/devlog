...
export function TagPopover({ tags }: TagPopoverProps) {
  ...
  return (
    <Popover className="relative">
      <PopoverButton className="outline-none relative px-4 py-2 rounded-lg text-slate-700 dark:text-slate-300 transition-all duration-300 active:text-slate-900 dark:active:text-slate-50 group">
        ...
        <span className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-gradient-to-r from-pink-500 to-orange-500 group-active:w-full group-active:left-0 transition-all duration-300 -z-0"></span>
      </PopoverButton>
      <PopoverPanel
        anchor="bottom end"
