---
title: Why Use JWT? Know Before You Use It
description: There's a reason session-based auth is the classic approach.
date: 2025-03-30
tags:
  - Web
---

To get straight to the point: don't use JWT in systems that require service blocking features.
